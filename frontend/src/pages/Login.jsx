              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    {...register('password')}
                    className={`w-full pl-10 pr-10 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-4 focus:ring-primary-500/15 focus:border-primary-500 transition ${
